...
API_ID = int(environ['24489709'])
API_HASH = environ['fa7140f1d17d8be530edc4622fd432c9']
BOT_TOKEN = environ['6780255961:AAG16bY-HrmQGjx_BsBoBq4m6BytM5dB5vI']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1402943117').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://GURUGR:GURUGR@cluster0.dsvcevp.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('-1002004232478', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/smilemoviestel')
